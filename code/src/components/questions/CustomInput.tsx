...
export default class CustomInput extends React.Component<Props, {}> {
  ...
  componentWillMount() {
    if (!isEmpty(this.props.question) && this.props.question.answer && !isEmpty(String(this.props.question.answer)) && String(this.props.question.answer).length > 0) {
  ...
  componentWillReceiveProps(nextProps) {
    if (!isEmpty(nextProps.question) && this.props.question.answer && !isEmpty(String(nextProps.question.answer)) && String(nextProps.question.answer).length > 0) {
